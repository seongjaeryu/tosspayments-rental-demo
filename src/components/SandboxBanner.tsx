      ...
      <div className="max-w-lg mx-auto px-4 h-11 flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0 relative overflow-hidden">
          ...
          >
            ...
            <span className="inline-flex items-center rounded-md bg-toss-gray-50 px-1.5 py-px text-[8px] font-bold text-toss-gray-300 border border-toss-gray-100 shrink-0 leading-tight">
              TEST
            </span>
          </div>
